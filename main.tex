...
We will be studying the product $G_1\boxprod G_2$ of two connected $n$-vertex graphs $G_1$ and $G_2$. \Cref{same_height_unrelated,anything_times_star} allow us to dispense with the case when $n_i(T_b)\in\Omega(n)$ for some $i$. The following lemma will be helpful when this is not possible.  (In several places, including the following lemma we will make use of the solution to the Basel Problem: $\sum_{i=1}^\infty 1/i^2 = \pi^2/6$.)
